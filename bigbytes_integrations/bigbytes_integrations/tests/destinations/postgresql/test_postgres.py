...
from bigbytes_integrations.destinations.postgresql import PostgreSQL
from bigbytes_integrations.tests.destinations.sql.mixins import SQLDestinationMixin
...
class PostgreSQLDestinationTests(unittest.TestCase, SQLDestinationMixin):
    ...
    conn_class_path = 'bigbytes_integrations.destinations.postgresql.PostgreSQLConnection'
