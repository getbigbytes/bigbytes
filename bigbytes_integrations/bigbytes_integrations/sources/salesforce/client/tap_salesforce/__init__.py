...
from bigbytes_integrations.sources.base import write_schema, write_state
from bigbytes_integrations.sources.salesforce.client.tap_salesforce import salesforce
from bigbytes_integrations.sources.salesforce.client.tap_salesforce.salesforce import (
    Salesforce,
)
from bigbytes_integrations.sources.salesforce.client.tap_salesforce.salesforce.credentials import (
    OAuthCredentials,
    PasswordCredentials,
    parse_credentials,
)
from bigbytes_integrations.sources.salesforce.client.tap_salesforce.salesforce.exceptions import (
    TapSalesforceException,
    TapSalesforceQuotaExceededException,
)
from bigbytes_integrations.sources.salesforce.client.tap_salesforce.sync import (
    get_stream_version,
