...
from bigbytes_integrations.sources.salesforce.client.tap_salesforce.salesforce.bulk import (
    Bulk,
)
...
from bigbytes_integrations.sources.salesforce.client.tap_salesforce.salesforce.rest import (
    Rest,
)
