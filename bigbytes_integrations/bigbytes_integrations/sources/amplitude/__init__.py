...
from bigbytes_integrations.connections.amplitude import Amplitude as AmplitudeConnection
from bigbytes_integrations.sources.amplitude.constants import (
    TABLE_KEY_PROPERTIES,
    VALID_REPLICATION_KEYS,
)
from bigbytes_integrations.sources.base import Source, main
from bigbytes_integrations.sources.constants import REPLICATION_METHOD_INCREMENTAL
from bigbytes_integrations.sources.query import get_end_date, get_start_date
