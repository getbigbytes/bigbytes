...
from bigbytes_integrations.connections.postgresql import PostgreSQL as PostgreSQLConnection
...
from bigbytes_integrations.sources.messages import write_state
from bigbytes_integrations.sources.postgresql.decoders import (
    Delete,
    Insert,
    Relation,
    Update,
