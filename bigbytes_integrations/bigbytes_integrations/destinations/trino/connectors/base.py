...
from bigbytes_integrations.connections.trino import Trino as TrinoConnection
from bigbytes_integrations.destinations.constants import UNIQUE_CONFLICT_METHOD_UPDATE
from bigbytes_integrations.destinations.sql.base import Destination
...
from bigbytes_integrations.destinations.trino.utils import (
    convert_column_type,
