...
docker run -it -p 6789:6789 -v $(pwd):/home/src \
    -e SOME_VARIABLE_NAME_1=secret_value_1 -e SOME_VARIABLE_NAME_2=secret_value_2 \
    bigbytes/bigbytes /app/run_app.sh bigbytes start [project_name]
```
...
| `DEFAULT_EXECUTOR_TYPE`          | The default executor type to run blocks                                                                                                                         | See enum types [here](https://docs.bigbytes.io/production/configuring-production-settings/compute-resource#2-set-executor-type-and-customize-the-compute-resource-of-the-bigbytes-executor) |
...
| `LOGS_DIR_PATH`                  | Override the logs directory path. Default path is the variables_dir path (e.g. `/home/src/bigbytes_data/`)                                                          | `/home/src/logs_dir`                                                     |
...
| `BIGBYTES_CACHE_DIRECTORY`           | The directory Bigbytes uses for storing and retrieving temporary data used in the UI.                                                                               | `/root/.bigbytes_data/default_repo/.cache`                                   |
...
| `USER_CODE_PATH`                 | Set this path to be `/home/src/{your_project_name}` so that Bigbytes starts your project and installs the packages in requirements.txt when starting the container. | `/home/src/bigbytes_project`                                                 |
