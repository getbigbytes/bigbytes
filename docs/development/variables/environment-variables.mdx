...
docker run -it -p 6789:6789 -v $(pwd):/home/src \
    -e SOME_VARIABLE_NAME_1=secret_value_1 -e SOME_VARIABLE_NAME_2=secret_value_2 \
    digitranslab/bigbytes /app/run_app.sh mage start [project_name]
```
...
| `DEFAULT_EXECUTOR_TYPE`          | The default executor type to run blocks                                                                                                                         | See enum types [here](https://docs.bigbytes.ai/production/configuring-production-settings/compute-resource#2-set-executor-type-and-customize-the-compute-resource-of-the-bigbytes-executor) |
...
| `MAGE_BASE_PATH`                 | The base path or prefix of the Bigbytes server url. [More information](/getting-started/setup#setting-prefix-for-bigbytes-url)                                          | `base/path`                                                              |
| `MAGE_REQUESTS_BASE_PATH`        | [More information](/getting-started/setup#setting-prefix-for-bigbytes-url)                                                                                          | `base/path`                                                              |
| `MAGE_ROUTESBASE_PATH`           | [More information](/getting-started/setup#setting-prefix-for-bigbytes-url)                                                                                          | `base/path`                                                              |
| `MAGE_CACHE_DIRECTORY`           | The directory Bigbytes uses for storing and retrieving temporary data used in the UI.                                                                               | `/root/.mage_data/default_repo/.cache`                                   |
...
| `MAGE_PUBLIC_HOST`               | The public host url that can be used to access the Bigbytes app. This value will be used in emails or other notifications.                                          | `http://localhost:6789`                                                  |
