...
- `bigbytes/bigbytes`: Specifies the Bigbytes Docker image to use.
...
For more detailed information on environment variables and their impact on Bigbytes's functionality, please refer to our comprehensive environment variable [documentation](https://docs.bigbytes.io/development/variables/environment-variables).
</Accordion>
...
```Bash
FROM bigbytes/bigbytes:latest

### Set up project-specific arguments
ARG PROJECT_NAME=[project_name]
ARG BIGBYTES_CODE_PATH=/home/bigbytes_code
...
1. `FROM bigbytes/bigbytes:latest`
...
Follow the [Repository setup](https://docs.bigbytes.io/production/ci-cd/local-cloud/repository-setup) documentation to deploy this
