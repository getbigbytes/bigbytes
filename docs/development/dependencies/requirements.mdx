...
<img
  alt="Python mecha"
  src="https://github.com/digitranslab/assets/blob/main/development/python-package.png?raw=true"
  width="250"
></img>
</p>
...
- `digitranslab/bigbytes`: Specifies the Bigbytes Docker image to use.
...
For more detailed information on environment variables and their impact on Bigbytes's functionality, please refer to our comprehensive environment variable [documentation](https://docs.bigbytes.ai/development/variables/environment-variables).
</Accordion>
...
```Bash
FROM digitranslab/bigbytes:latest
...
1. `FROM digitranslab/bigbytes:latest`
...
- `MAGE_CODE_PATH`: Sets the base path for Bigbytes code.
...
Follow the [Repository setup](https://docs.bigbytes.ai/production/ci-cd/local-cloud/repository-setup) documentation to deploy this
