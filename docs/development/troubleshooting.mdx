...
Thankfully, [Bigbytes Community](https://www.bigbytes.io/chat) member [Josh Pachner](https://bigbytes.slack.com/team/U05B9DLK0N7) has a solution.
...
docker run -it -p 6789:6789
    ...
    -v $(pwd):/home/src bigbytes/bigbytes \
