...
Each pipeline is represented by a YAML file (here's an [example](https://github.com/digitranslab/demo_etl_pipeline/blob/master/pipelines/etl_demo/metadata.yaml)) in the `pipelines` folder under the Bigbytes project directory.

<img
  alt="Pipeline"
  src="https://github.com/digitranslab/assets/blob/main/overview/bigbytes-build.gif?raw=True"
/>
...
[data loader block](https://github.com/digitranslab/demo%5Fetl%5Fpipeline/blob/master/data%5Floaders/load%5Fdataset.py)
...
<img
  alt="Log detail"
  src="https://github.com/digitranslab/assets/blob/main/logs/log-detail.png?raw=true"
/>
