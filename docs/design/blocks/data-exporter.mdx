...
<img
  alt="exporter"
  src="https://github.com/digitranslab/assets/blob/main/blocks/exporter/data-exporter.gif?raw=True"
/>
...
It’s recommended to store sensitive information as Secrets. See the general [Secrets documentation](https://docs.bigbytes.ai/development/variables/secrets)
...
If you need more information on entering secrets see this [documentation](https://docs.bigbytes.ai/production/deploying-to-cloud/secrets/Azure).
