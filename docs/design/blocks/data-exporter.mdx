...
It’s recommended to store sensitive information as Secrets. See the general [Secrets documentation](https://docs.bigbytes.io/development/variables/secrets)
...
If you need more information on entering secrets see this [documentation](https://docs.bigbytes.io/production/deploying-to-cloud/secrets/Azure).
