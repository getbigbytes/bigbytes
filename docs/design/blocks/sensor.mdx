...
<img
  alt="Python mecha"
  src="https://github.com/digitranslab/assets/blob/main/blocks/grandwizard_a_big_mythical_spirit_like_eye_scanning_a_bunch_of__b030824d-801c-4f8d-a9bd-51f0681eaa78.png?raw=true"
  width="300"
/>
