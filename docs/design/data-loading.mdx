...
The Google Sheets class is defined [here](https://github.com/digitranslab/bigbytes/blob/master/bigbytes/io/google_sheets.py).
...
<Warning>
  ...
  or GCP Secret Manager, you can reference the following docs:
    - [Azure Key Vault](https://docs.bigbytes.io/production/deploying-to-cloud/secrets/Azure)
    - [GCP Secret Manager](https://docs.bigbytes.io/production/deploying-to-cloud/secrets/GCP)
</Warning>
