...
<Warning>
  ...
  or GCP Secret Manager, you can reference the following docs:
    - [Azure Key Vault](https://docs.bigbytes.ai/production/deploying-to-cloud/secrets/Azure)
    - [GCP Secret Manager](https://docs.bigbytes.ai/production/deploying-to-cloud/secrets/GCP)
</Warning>
