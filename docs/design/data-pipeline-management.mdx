...
icon: "pipe-section"
"og:image": "https://github.com/digitranslab/assets/blob/main/orchestration-overview.gif?raw=true"
---

<Frame>
  <img
    alt="Bigbytes orchestration"
    src="https://github.com/digitranslab/assets/blob/main/orchestration-overview.gif?raw=true"
  />
</Frame>
...
![Pipelines](https://github.com/digitranslab/assets/blob/main/pipelines/pipelines-index.jpg?raw=true)
...
![Pipeline runs](https://github.com/digitranslab/assets/blob/main/pipelines/pipeline-runs.jpg?raw=true)
...
![Pipeline detail](https://github.com/digitranslab/assets/blob/main/pipelines/pipeline-detail.jpg?raw=true)
...
![Trigger create](https://github.com/digitranslab/assets/blob/main/pipelines/trigger-create.jpg?raw=true)
...
![Trigger detail](https://github.com/digitranslab/assets/blob/main/pipelines/trigger-detail.jpg?raw=true)
...
![Pipeline detail runs](https://github.com/digitranslab/assets/blob/main/pipelines/pipeline-detail-runs.jpg?raw=true)
...
![Pipeline detail logs](https://github.com/digitranslab/assets/blob/main/pipelines/pipeline-detail-logs.jpg?raw=true)
...
<img
  alt="Monitoring"
  src="https://github.com/digitranslab/assets/blob/main/monitoring.jpg?raw=true"
/>
...
* Specify the data directory path via `MAGE_DATA_DIR` environment variable. If you use Bigbytes docker image, this environment
