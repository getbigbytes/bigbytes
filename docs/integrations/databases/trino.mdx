...
Read these [instructions](https://github.com/digitranslab/bigbytes/blob/master/bigbytes_integrations/bigbytes_integrations/destinations/trino/README.md#run-trino-locally)
