...
docker run -it -p 6789:6789 -v $(pwd):/home/src \
  digitranslab/bigbytes /app/run_app.sh mage init demo_project
...
<img alt="Bigbytes in Airflow" src="https://github.com/digitranslab/assets/blob/main/mage-airflow.jpg?raw=True" />
</Step>
</Steps>
