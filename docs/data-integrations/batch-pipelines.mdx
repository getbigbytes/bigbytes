...
<Frame>
    ...
    <img
        alt="Example"
        src="https://github.com/digitranslab/assets/blob/main/batch-pipelines/data-integrations/block-runs.png?raw=true"
    />
    </p>
</Frame>
    ...
    <Frame>
        <p align="center">
            <img
                ...
                src="https://github.com/digitranslab/assets/blob/main/batch-pipelines/data-integrations/add-source-block.png?raw=true"
            />
        </p>
    </Frame>
...
1. Configure the source:
    ...
    <Frame>
        <p align="center">
            <img
                alt="Source block"
                src="https://github.com/digitranslab/assets/blob/main/batch-pipelines/data-integrations/source-block.png?raw=true"
            />
        </p>
    </Frame>
    ...
    <Frame>
        <p align="center">
            <img
                ...
                src="https://github.com/digitranslab/assets/blob/main/batch-pipelines/data-integrations/add-destination-block.png?raw=true"
            />
        </p>
    </Frame>
    ...
    <Frame>
        <p align="center">
            <img
                ...
                src="https://github.com/digitranslab/assets/blob/main/batch-pipelines/data-integrations/destination-block.png?raw=true"
            />
        </p>
    </Frame>
...
<Frame>
    <p align="center">
        <img
            ...
            src="https://github.com/digitranslab/assets/blob/main/batch-pipelines/data-integrations/configuration-credentials.png?raw=true"
        />
    </p>
</Frame>
...
<Frame>
    <p align="center">
        <img
            ...
            src="https://github.com/digitranslab/assets/blob/main/batch-pipelines/data-integrations/configuration-upstream-block-settings.png?raw=true"
        />
    </p>
</Frame>
...
<Frame>
    <p align="center">
        <img
            alt="Select streams"
            src="https://github.com/digitranslab/assets/blob/main/batch-pipelines/data-integrations/streams.png?raw=true"
        />
    </p>
</Frame>
...
<Frame>
    <p align="center">
        <img
            ...
            src="https://github.com/digitranslab/assets/blob/main/batch-pipelines/data-integrations/overview.png?raw=true"
        />
    </p>
</Frame>
...
<Frame>
    <p align="center">
        <img
            ...
            src="https://github.com/digitranslab/assets/blob/main/batch-pipelines/data-integrations/stream-detail-overview.png?raw=true"
        />
    </p>
</Frame>
...
<Frame>
    <p align="center">
        <img
            ...
            src="https://github.com/digitranslab/assets/blob/main/batch-pipelines/data-integrations/stream-detail-schema-properties.png?raw=true"
        />
    </p>
</Frame>
...
<Frame>
    <p align="center">
        <img
            ...
            src="https://github.com/digitranslab/assets/blob/main/batch-pipelines/data-integrations/stream-detail-sample-data.png?raw=true"
        />
    </p>
</Frame>
...
| Description | A list of stream names are retrieved by the source’s underlying code in the [Bigbytes Integrations library](https://github.com/digitranslab/bigbytes/tree/master/bigbytes_integrations/bigbytes_integrations/sources). |
| Available in | Sources only |
...
<Accordion title="JSON format">
    ```json
    {
      "columns": [
        ...
        "cabin",
        "embarked",
        "_bigbytes_created_at",
        "_bigbytes_updated_at"
      ],
      "stream": {
    ...
    <Accordion title="Trigger pipeline to run once" icon="repeat-1" iconType="duotone">
        <Frame>
            <video
                ...
                src="https://github.com/digitranslab/assets/raw/main/batch-pipelines/data-integrations/incremental/triggers-once.mp4"
            />
        </Frame>
    </Accordion>
    ...
    <Accordion title="New trigger or edit an existing trigger" icon="bolt" iconType="duotone">
        <Frame>
            <video
                controls
                className="w-full aspect-video"
                src="https://github.com/digitranslab/assets/raw/main/batch-pipelines/data-integrations/incremental/triggers-edit.mp4"
            />
        </Frame>
    </Accordion>
</AccordionGroup>
...
<Frame>
    ...
    <img
        ...
        src="https://github.com/digitranslab/assets/blob/main/batch-pipelines/data-integrations/incremental/bookmark-values.png?raw=true"
    />
    </p>
</Frame>
