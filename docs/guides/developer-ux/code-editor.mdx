...
<AccordionGroup>
        ...
        <Frame>
            <p align="center">
                <img
                    ...
                    src="https://github.com/digitranslab/assets/blob/main/dev-ux/code-editor/drag-block.gif?raw=true"
                />
            </p>
        </Frame>
    </Accordion>
        ...
        <Frame>
            <p align="center">
                <img
                    ...
                    src="https://github.com/digitranslab/assets/blob/main/dev-ux/code-editor/block-search.gif?raw=true"
                />
            </p>
        </Frame>
    ...
    <Accordion title="Custom code templates for reducing boilerplate work" icon="cauldron" iconType="duotone">
        ...
        <video
            ...
            src="https://github.com/digitranslab/assets/raw/main/custom-templates/blocks/overview.mp4">
        </video>
        ...
        <Frame>
            <p align="center">
                <img
                    ...
                    src="https://github.com/digitranslab/assets/blob/main/dev-ux/code-editor/rearrange-blocks.gif?raw=true"
                />
            </p>
        </Frame>
    </Accordion>
    ...
    <Accordion title="Show blocks in current pipeline" icon="user-secret" iconType="duotone">
        ...
        <Frame>
            ...
            <img
                ...
                src="https://github.com/digitranslab/assets/blob/main/dev-ux/file-browser/blocks-in-pipeline.gif?raw=true"
            />
            </p>
        </Frame>
    </Accordion>
...
<Frame>
    ...
    <img
        ...
        src="https://github.com/digitranslab/assets/blob/main/dev-ux/code-editor/ai-generate-code.gif?raw=True"
    />
    </p>
</Frame>
    ...
    <Accordion title="Document the code from a block" icon="scroll" iconType="duotone" defaultOpen>
        <Frame>
            ...
            <img
                ...
                src="https://github.com/digitranslab/assets/blob/main/dev-ux/code-editor/ai-document-block.gif?raw=True"
            />
            </p>
        </Frame>
    ...
    <Accordion title="Write comments inline with the code" icon="comments" iconType="duotone">
        <Frame>
            ...
            <img
                ...
                src="https://github.com/digitranslab/assets/blob/main/dev-ux/code-editor/ai-code-comments.gif?raw=True"
            />
            </p>
        </Frame>
    ...
    <Accordion title="Document the entire pipeline and each block in it" icon="book" iconType="duotone">
        <Frame>
            ...
            <img
                ...
                src="https://github.com/digitranslab/assets/blob/main/dev-ux/code-editor/ai-document-pipeline.gif?raw=True"
            />
            </p>
        </Frame>
    ...
    <Accordion title="Recursively dynamic code made simple" defaultOpen icon="spider-web" iconType="duotone">
        <Frame>
            ...
            <img
                ...
                src="https://github.com/digitranslab/assets/blob/main/dev-ux/code-editor/dynamic-blocks.png?raw=True"
            />
            </p>
        </Frame>
    ...
    <Accordion title="Replicate the code of an existing block" icon="sheep" iconType="duotone">
        <Frame>
            ...
            <img
                ...
                src="https://github.com/digitranslab/assets/blob/main/dev-ux/code-editor/replicate-block.gif?raw=True"
            />
            </p>
        </Frame>
    ...
    <Accordion title="Conditionally execute code" icon="code-merge" iconType="duotone">
        <Frame>
            ...
            <img
                ...
                src="https://github.com/digitranslab/assets/blob/main/blocks/conditionals-example.png?raw=true"
            />
            </p>
        </Frame>
...
<Frame>
    <p align="center">
        <img
            ...
            src="https://github.com/digitranslab/assets/blob/main/dev-ux/code-editor/split-view.gif?raw=true"
        />
    </p>
</Frame>
