...
dropdown selection labeled `Set block as dynamic`.
    ![Dynamic data loader block](https://github.com/digitranslab/assets/blob/main/blocks/dynamic-block-data-loader.png?raw=true)
...
1. Run the transformer block and the output will be:
    ...
    ![Dynamic child transformer block 1](https://github.com/digitranslab/assets/blob/main/blocks/dynamic-block-transformer1.png?raw=true)
...
1. Run the transformer block and the output should look something like this:
    ...
    ![Dynamic child transformer block 2](https://github.com/digitranslab/assets/blob/main/blocks/dynamic-block-transformer2.png?raw=true)
...
1. Run the data exporter block and the output should look something like this:
    ...
    ![Data exporter block from dynamically created block with reduce output](https://github.com/digitranslab/assets/blob/main/blocks/dynamic-block-data-exporter.png?raw=true)

The pipeline’s final dependency graph should look like this:

![Dynamic block dependency graph](https://github.com/digitranslab/assets/blob/main/blocks/dynamic-block-graph.jpg?raw=true)
...
![Dynamic block runs](https://github.com/digitranslab/assets/blob/main/blocks/dynamic-block-runs.png?raw=true)
