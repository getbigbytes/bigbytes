...
![Image of transformer block template drop down highlighting "Fill in missing values"](https://github.com/digitranslab/assets/blob/main/blocks/transformers/transformer_actions_impute.png?raw=true)
...
![Image of transformer block template drop down highlighting "Aggregate/Aggregate by average value"](https://github.com/digitranslab/assets/blob/main/transformer_actions_agg.png?raw=True)
