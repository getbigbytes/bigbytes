        ...
        **SSH keys with passphrase are not supported**
        ...
        <Steps>
            ...
            <Step title="Navigate to Git settings">
                ...
                <Frame>
                <img src="https://github.com/digitranslab/assets/blob/main/bigbytes-settings.png?raw=True"/>
                </Frame>
            ...
            <Step title="Select SSH as the authentication type.">
                ...
                <Frame>
                <img src="https://github.com/digitranslab/assets/blob/main/git-settings.png?raw=True"/>
                </Frame>
            </Step>
