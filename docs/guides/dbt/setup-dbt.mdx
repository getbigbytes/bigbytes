...
The following command will clone the [demo repo](https://github.com/digitranslab/dbt-quickstart), copy `dev.env` to `.env` and run `docker compose up` to start Bigbytes _and_ a Postgres database.

<CodeGroup>
```bash Mac/Linux
git clone https://github.com/digitranslab/dbt-quickstart bigbytes-dbt-quickstart \
...
![Open Pipelines](https://github.com/digitranslab/assets/blob/main/dbt/setup-dbt/go-to-pipelines.gif?raw=True)
...
![Run simple pipeline](https://github.com/digitranslab/assets/blob/main/dbt/setup-dbt/simple-pipeline.png?raw=True)
...
![Compile external pipeline](https://github.com/digitranslab/assets/blob/main/dbt/setup-dbt/external-pipeline.png?raw=True)
...
![Trigger dbt](https://github.com/digitranslab/assets/blob/main/dbt/setup-dbt/trigger-dbt.gif?raw=True)
