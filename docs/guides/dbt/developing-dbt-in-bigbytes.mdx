...
<Step title="Add dbt model block to pipeline">
    ...
    ![](https://github.com/digitranslab/assets/blob/main/dbt/add-dbt-model.gif?raw=true)
</Step>
<Step title="Edit my_first_dbt_model">
    ...
    ![](https://github.com/digitranslab/assets/blob/main/dbt/dbt-preview.gif?raw=true)
    ...
    ![](https://github.com/digitranslab/assets/blob/main/dbt/run-model.png?raw=true)
...
- Paste the following SQL into the dbt model named `my_second_dbt_model`:
   ...
   LEFT JOIN {{ source('bigbytes_demo', 'dbt_demo_pipeline_load_data') }} AS b
   ON 1 = 1
   ...
   > `demo_project/dbt/demo/models/bigbytes_sources.yml` file.
   >
