...
<video
    ...
    src="https://github.com/digitranslab/assets/raw/main/version-control/demo.mp4">
</video>

## Setup

<Frame>
    <img alt="Setup" src="https://github.com/digitranslab/assets/blob/main/version-control/setup.png?raw=true" />
</Frame>
...
First, you will need to enable the [Active Directory](https://docs.bigbytes.io/production/authentication/microsoft) integration in order for Bigbytes to authenticate your user.
...
<Frame>
    <img alt="Authenticate" src="https://github.com/digitranslab/assets/blob/main/version-control/authentication.png?raw=true" />
</Frame>
...
For example, the remote URL for Bigbytes is `https://github.com/digitranslab/bigbytes.git`.
...
<Frame>
    <img alt="Branches" src="https://github.com/digitranslab/assets/blob/main/version-control/branches.png?raw=true" />
</Frame>
...
<Frame>
    <img alt="Files" src="https://github.com/digitranslab/assets/blob/main/version-control/files.png?raw=true" />
</Frame>
...
<Frame>
    <img alt="Push" src="https://github.com/digitranslab/assets/blob/main/version-control/push.png?raw=true" />
</Frame>
