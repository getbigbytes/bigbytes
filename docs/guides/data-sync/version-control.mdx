...
First, you will need to enable the [Active Directory](https://docs.bigbytes.ai/production/authentication/microsoft) integration in order for Bigbytes to authenticate your user.
