...
<CodeGroup>
```bash Mac/Linux
git clone https://github.com/digitranslab/etl-demo bigbytes-etl-demo \
...
<AccordionGroup>
    <Accordion title="1️⃣ Create a pipeline">
        ...
        <Frame>
            <img
                ...
                src="https://github.com/digitranslab/assets/blob/main/tutorials/etl/create-new-pipeline.gif?raw=true"
            />
        </Frame>
        ...
        * `Shift + Enter`
        ...
        After you run the block (⌘ + Enter), you'll see a sample of the data that was loaded.
            ...
            <Frame>
                <img
                    alt="Load data"
                    src="https://github.com/digitranslab/assets/blob/main/tutorials/etl/load-data.gif?raw=true"
                />
            </Frame>
    </Accordion>
    <Accordion title="3️⃣ Transform data">
        ...
        * Clean the column names to properly store in a PostgreSQL database.
        ...
        <Frame>
            <img
                alt="Transform data"
                src="https://github.com/digitranslab/assets/blob/main/tutorials/etl/transform-data.gif?raw=true"
            />
        </Frame>
    </Accordion>
    <Accordion title="4️⃣ Export data to DuckDB">
        ...
        <Frame>
            <img
                alt="Export data"
                src="https://github.com/digitranslab/assets/blob/main/tutorials/etl/export-data.gif?raw=true"
            />
        </Frame>
...
<img
    ...
    src="https://raw.githubusercontent.com/digitranslab/assets/af9fafa41d823fe8e710d54f86164bef4378f5c3/mascots/earth/casting.svg"
/>

If you have more questions or ideas, get real-time help in our live support
[Slack channel](https://www.bigbytes.ai/chat).
