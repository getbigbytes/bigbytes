...
[bigbytes/tests](https://github.com/digitranslab/bigbytes/tree/master/bigbytes/tests) directory.
...
8dbcfbe41755   mage/data   "./scripts/install_a…"   5 days ago   Up 38 minutes   0.0.0.0:3000->3000/tcp   bigbytes-app-1
b9d811e1e3e8   mage/data   "python bigbytes/serv…"   5 days ago   Up 38 minutes   0.0.0.0:6789->6789/tcp   bigbytes-server-1
```
