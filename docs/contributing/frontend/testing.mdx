...
[development environment](https://docs.bigbytes.io/contributing/development-environment).
- Make sure [user authentication](https://docs.bigbytes.io/production/authentication/overview) is enabled.
...
If you are running into issues with the app and would like to report it, you can tell us about it either on [GitHub](https://github.com/digitranslab/bigbytes/issues/new/choose) or [Slack](https://www.bigbytes.io/chat).
