...
<Step title="Configure your development environment">
   Configure your coding environment for local development: `pyenv`, pre-commit hooks, etc. Follow the instructions [here](https://github.com/digitranslab/bigbytes/blob/master/README_dev.md).
</Step>
...
<img src="https://github.com/digitranslab/assets/blob/main/development/windows/update-crlf-to-lf-vscode.gif?raw=True"/>
