...
Add a new type in [`bigbytes/data_preparation/models/widget/constants.py`](https://github.com/digitranslab/bigbytes/blob/master/bigbytes/data_preparation/models/widget/constants.py):
...
Add a new type in [`bigbytes/frontend/interfaces/ChartBlockType.ts`](https://github.com/digitranslab/bigbytes/blob/master/bigbytes/frontend/interfaces/ChartBlockType.ts):
