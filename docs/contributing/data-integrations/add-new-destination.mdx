...
Here is an example PR for adding a new destination: https://github.com/digitranslab/bigbytes/pull/2277
...
[`bigbytes_integrations/destinations/amazon_s3/__init__.py`](https://github.com/digitranslab/bigbytes/blob/master/bigbytes_integrations/bigbytes_integrations/destinations/amazon_s3/__init__.py)
...
[base destination class](https://github.com/digitranslab/bigbytes/blob/master/bigbytes_integrations/bigbytes_integrations/destinations/base.py).

If you're adding a destination for a SQL data warehouse or database, you can subclass the
[base sql destination class](https://github.com/digitranslab/bigbytes/blob/master/bigbytes_integrations/bigbytes_integrations/destinations/sql/base.py)
...
Add the new destination to the `DESTINATIONS` list constant in this file: https://github.com/digitranslab/bigbytes/blob/master/bigbytes/data_integrations/destinations/constants.py

## 5. Test your desination

Follow this [doc](https://github.com/digitranslab/bigbytes/tree/master/bigbytes_integrations) to test your new destination.
...
pip install "git+https://github.com/your_repo.git@your_branch#egg=mage-integrations&subdirectory=bigbytes_integrations"
```
