...
```bash
git clone https://github.com/digitranslab/bigbytes.git
cd bigbytes
```
...
- An `__init__.py` file that contains the logic for fetching data from the source.
  ...
  - A `discover` method that returns a [Catalog](https://github.com/digitranslab/bigbytes/blob/master/bigbytes_integrations/bigbytes_integrations/sources/catalog.py) of streams.
...
Navigate to `/digitranslab/bigbytes_integrations/bigbytes_integrations/sources` and create a copy of the `titanic` directory:
...
When naming schemas, use the plural name of the object you're referencing. This plural name will be displayed to the individual who is setting up a synchronization using this source. Take the [sample "passengers" schema](https://github.com/digitranslab/bigbytes/tree/master/bigbytes_integrations/bigbytes_integrations/sources/titanic/schemas/passengers.json) for example:
...
The following simple example is present in the [Titanic source](https://github.com/digitranslab/bigbytes/tree/master/bigbytes_integrations/bigbytes_integrations/sources/titanic/templates/config.json).
...
A majority of source logic lives in the `__init__.py` file. Most of the work in adding your own source will involve creating/overwriting methods from `__init__.py`. [Our sample](https://github.com/digitranslab/bigbytes/tree/master/bigbytes_integrations/bigbytes_integrations/sources/titanic/__init__.py) contains the following:
...
The list of sources is available [here](https://github.com/digitranslab/bigbytes/blob/master/bigbytes/data_integrations/sources/constants.py), add yours to make it accessible via the UI.

## Document your source

Document how to configure and use your source in the `README.md` file at the source's root directory. Documentation helps Bigbytesrs and future contributor understand exactly how your source works! Be sure to be thorough and descriptive. [Here's an example](https://github.com/digitranslab/bigbytes/blob/master/bigbytes_integrations/bigbytes_integrations/sources/salesforce/README.md) of documentation done well.

## Test your source

You'll first need to configure your [development environment](https://docs.bigbytes.io/contributing/development-environment). Once complete, follow this [doc](https://github.com/digitranslab/bigbytes/tree/master/bigbytes_integrations) to test your new source.