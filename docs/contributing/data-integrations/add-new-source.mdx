...
You'll first need to configure your [development environment](https://docs.bigbytes.ai/contributing/development-environment). Once complete, follow this [doc](https://github.com/digitranslab/bigbytes/tree/master/bigbytes_integrations) to test your new source.