...
Don't forget to use absolute imports for these files. [HubSpot](https://github.com/digitranslab/bigbytes/tree/master/bigbytes_integrations/bigbytes_integrations/sources/hubspot) is another good example of a completed tap.
...
def discover(client, logger=None):
    ...
    """
    bigbytes_logger = logger or LOGGER
```

Then replace usage of `LOGGER` with `bigbytes_logger`.
...
for stream_name, schema_dict in schemas.items():
        try:
            ...
            bigbytes_logger.error(err)
            bigbytes_logger.error('stream_name: %s', stream_name)
            bigbytes_logger.error('type schema_dict: %s', type(schema_dict))
            raise err
```
...
Add the new source to the `SOURCES` list constant in [this](https://github.com/digitranslab/bigbytes/blob/master/bigbytes/data_integrations/sources/constants.py) file
...
* See [HubSpot](https://github.com/digitranslab/bigbytes/tree/master/bigbytes_integrations/bigbytes_integrations/sources/hubspot) or [GitHub](https://github.com/digitranslab/bigbytes/tree/master/bigbytes_integrations/bigbytes_integrations/sources/github) for examples.
