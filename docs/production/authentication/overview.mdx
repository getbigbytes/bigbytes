...
docker run -it -p 6789:6789 \
  ...
  digitranslab/bigbytes /app/run_app.sh bigbytes start demo_project
```
...
![Sign in page](https://raw.githubusercontent.com/digitranslab/assets/main/users/sign-in.jpg)
...
![Sign in page](https://raw.githubusercontent.com/digitranslab/assets/main/users/users-list.jpg)
