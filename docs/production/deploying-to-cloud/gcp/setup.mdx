...
[./gcp/variables.tf](https://github.com/digitranslab/bigbytes-terraform-templates/blob/master/gcp/variables.tf)
file.
...
[./gcp/main.tf](https://github.com/digitranslab/bigbytes-terraform-templates/blob/master/gcp/main.tf):
...
3.  Under the field labeled **New principles**, add the service account that is
    ...
    <Note>
      ...
      [`main.tf`](https://github.com/digitranslab/bigbytes-terraform-templates/blob/master/gcp/main.tf#L99):
...
```
docker pull --platform linux/amd64 bigbytes/bigbytes:latest
```
...
[this example](https://github.com/digitranslab/bigbytes-terraform-templates/blob/master/gcp/load_balancer.tf#L23-L33)
