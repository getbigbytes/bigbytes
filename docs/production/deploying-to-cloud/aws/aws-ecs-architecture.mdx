...
<Frame height="400" caption="An architecture diagram of a Bigbytes AWS ECS deployment.">
  <img alt="Contributing" src="https://github.com/digitranslab/assets/blob/main/architecture/aws-ecs.png?raw=True" />
</Frame>
...
We use EFS to store a persistent volume where the `bigbytes_data` for your project is stored. You can learn more about what is stored in `bigbytes_data` [here](/design/abstractions/project-structure#project-data). Without EFS, your project data would be lost when your ECS service is terminated. EFS allows us to persist data between containers within ECS.
