...
* If you are not using ECS to run Bigbytes, then this document will not apply for you.
  You can submit a feature request in our [Slack channel](https://www.bigbytes.io/chat) if you want Bigbytes to
...
[Here is a reference Dockerfile](https://github.com/digitranslab/docker/blob/master/Dockerfile)
...
Use Terraform scripts in [aws-code-pipeline](https://github.com/digitranslab/bigbytes-terraform-templates/tree/master/aws-code-pipeline)
...
In the file
[./aws/variables.tf](https://github.com/digitranslab/bigbytes-terraform-templates/blob/master/aws-code-pipeline/variables.tf),
...
![bigbytes-codepipeline](https://github.com/digitranslab/assets/blob/main/bigbytes-codepipeline.png?raw=True)

![bigbytes-codepipeline-ecr](https://github.com/digitranslab/assets/blob/main/bigbytes-codepipeline-ecr.png?raw=True)
