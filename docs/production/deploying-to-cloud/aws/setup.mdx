...
Use Terraform scripts in [aws](https://github.com/digitranslab/bigbytes-terraform-templates/tree/master/aws)
...
In the file
[./aws/variables.tf](https://github.com/digitranslab/bigbytes-terraform-templates/blob/master/aws/variables.tf),
...
variable "docker_image" {
  ...
  default     = "digitranslab/bigbytes:latest"
}
```
...
In the
[`./aws/env_vars.json`](https://github.com/digitranslab/bigbytes-terraform-templates/blob/master/aws/env_vars.json)
...
```bash
docker run -i -t -v $(pwd):/mage --workdir="/absolute_path_to/bigbytes-terraform-templates/aws" \
...
Use Terraform scripts in [aws-eks](https://github.com/digitranslab/bigbytes-terraform-templates/tree/master/aws-eks)
...
Similar with deploying to ECS cluster, you need to set up the [environment variables](/production/deploying-to-cloud/aws/setup#1-environment-variables) first, and you can customize the Terraform settings in [./aws-eks/variables.tf](https://github.com/digitranslab/bigbytes-terraform-templates/blob/master/aws-eks/variables.tf) file.
...
Update the `EFS_VOLUME_ID` in [kube/efs-pvc.yaml](https://github.com/digitranslab/bigbytes-terraform-templates/blob/master/aws-eks/kube/efs-pvc.yaml) to the efs id in terraform output
</Step>
