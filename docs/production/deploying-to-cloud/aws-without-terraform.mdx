...
Currently only connections via SSH are supported. To access [this script](https://github.com/digitranslab/bigbytes/blob/master/scripts/run_ec2.sh)
clone this [repository](https://github.com/digitranslab/bigbytes).
...
1. Create a new Docker image for launching the Bigbytes App— you can start with [our template](https://github.com/digitranslab/docker/blob/master/Dockerfile). Upload this Docker image to a repository like Amazon ECR so ECS tasks can pull and create Docker containers using this image.
