...
[./digitalocean/variables.tf](https://github.com/digitranslab/bigbytes-terraform-templates/blob/master/digitalocean/variables.tf), update the value of `ssh_pub_key` to your path of public key.
...
In the file
[./digitalocean/variables.tf](https://github.com/digitranslab/bigbytes-terraform-templates/blob/master/digitalocean/variables.tf),
...
```bash
docker run -d -p 6789:6789 -v $(pwd):/home/src bigbytes/bigbytes /app/run_app.sh bigbytes start default_repo
```
