...
![Bigbytes Azure architecture](https://github.com/digitranslab/assets/blob/main/production/deployment/azure/architecture.png?raw=true)
...
[./azure/variables.tf](https://github.com/digitranslab/bigbytes-terraform-templates/blob/master/azure/variables.tf)
file.
...
In the file
[./azure/main.tf](https://github.com/digitranslab/bigbytes-terraform-templates/blob/master/azure/main.tf),
