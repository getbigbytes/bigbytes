...
sidebarTitle: "AWS"
description: "Attention Bigbytesrs: This classified document contains vital intel on securing sensitive data within the AWS Secrets Manager vault. Study the protocols carefully to create and operationalize confidential secrets, granting you clearance to integrate them into your Bigbytes data pipeline projects."
icon: "aws"
---
![It's Classified](https://github.com/digitranslab/assets/blob/main/secrets_assets/Source_%20Giphy%20(4).gif?raw=True)
...
To use secrets in Python code, read these [**instructions**](https://docs.bigbytes.io/design/data-loading#aws-secret-loader).
...
![Secrets UI](https://github.com/digitranslab/assets/blob/main/secrets_assets/secrets_aws.png?raw=True)
3. Make the changes as pictured below to represent your secrets in the io_config.yml file
![io_config](https://github.com/digitranslab/assets/blob/main/secrets_assets/io_config_aws.png?raw=True)
...
![Shhhh](https://github.com/digitranslab/assets/blob/main/secrets_assets/Source_%20Giphy%20(5).gif?raw=True)
