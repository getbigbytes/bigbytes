...
Clone Bigbytes’s
[Terraform template repository](https://github.com/digitranslab/bigbytes-terraform-templates):

```bash
git clone https://github.com/digitranslab/bigbytes-terraform-templates.git
```
