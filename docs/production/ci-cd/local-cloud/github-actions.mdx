...
Bigbytes supports GitHub Actions for CI/CD workflows. We have templates for deploying to [AWS ECS, GCP Cloud Run, and Azure](https://github.com/digitranslab/bigbytes/tree/master/templates/github_actions).
...
13. Copy the contents from the GitHub Action YAML file for AWS at
    [templates/github_actions/build_and_deploy_to_aws_ecs.yml](https://github.com/digitranslab/bigbytes/blob/master/templates/github_actions/build_and_deploy_to_aws_ecs.yml),
...
8. Copy the contents from the GitHub Action YAML file for GCP at
   [templates/github_actions/build_and_deploy_to_gcp_cloud_run.yml](https://github.com/digitranslab/bigbytes/blob/master/templates/github_actions/build_and_deploy_to_gcp_cloud_run.yml),
   and paste it into the textarea.
9. Change the following values under the key labeled `env`:
   ...
   | `PROJECT_ID`                    | Project ID of where you launched Bigbytes using Terraform.                                      | `mage-123456` |
...
Our template for deploying to an Azure Container instance is located [here](https://github.com/digitranslab/bigbytes/blob/master/templates/github_actions/build_and_deploy_to_azure_container_instance.yml) and based off the "GitHub Workflow" option in Azure's docs.
