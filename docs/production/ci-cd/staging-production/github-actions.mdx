...
13. Copy the contents from the GitHub Action YAML file for AWS at
    [templates/github_actions/build_and_deploy_to_aws_ecs_staging_production.yml](https://github.com/digitranslab/bigbytes/blob/master/templates/github_actions/build_and_deploy_to_aws_ecs_staging_production.yml),
