...
![Create Global Variables](https://github.com/digitranslab/assets/blob/main/configure-runtime-variables.png?raw=True)

### In code

You can also create pipeline-level variables in code by editing the pipeline's `metadata.yaml` file.

![Create Pipeline Variables](https://github.com/digitranslab/assets/blob/main/configure-variables-in-code.png?raw=True)
