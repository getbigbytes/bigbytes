...
<AccordionGroup>
  <Accordion title="Docker" icon="docker">
    ...
    <CodeGroup>
      ```bash Mac/Linux
      docker run -it -p 6789:6789 -v $(pwd):/home/src bigbytes/bigbytes /app/run_app.sh bigbytes start [project_name]
      ```
      ```bash Windows Command Line
      docker run -it -p 6789:6789 -v "%cd%:/home/src" bigbytes/bigbytes /app/run_app.sh bigbytes start [project_name]
      ```
      ...
      sudo docker run -it -p 6789:6789 -v $(pwd):/home/src bigbytes/bigbytes /app/run_app.sh bigbytes start [project_name]
      ```
    </CodeGroup>
