...
- Launch a remote AWS EMR Spark cluster. Install bigbytes library in bootstrap
  ...
  - You can use the `create_emr.py` script under
    [scripts/spark](https://github.com/digitranslab/bigbytes/tree/master/scripts/spark)
...
![](https://github.com/digitranslab/assets/blob/main/switch_kernels.png?raw=True)
