...
[environment variable](https://docs.bigbytes.io/development/variables/environment-variables).
</Note>
...
`true` as defined in the base config). The other properties (i.e. `help_improve_bigbytes`,
