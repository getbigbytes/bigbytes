...
<img alt="requirements" src="https://github.com/digitranslab/assets/blob/main/requirements.png?raw=True" />
...
![create new pipeline](https://github.com/digitranslab/assets/blob/main/create-new-pipeline.gif?raw=True)
...
![](https://github.com/digitranslab/assets/blob/main/scratchpad.gif?raw=True)
...
![load data](https://github.com/digitranslab/assets/blob/main/load-data.gif?raw=True)
...
![Transform data](https://github.com/digitranslab/assets/blob/main/transform-data.gif?raw=True)
...
![Train model](https://github.com/digitranslab/assets/blob/main/train-model.gif?raw=True)
...
![](https://github.com/digitranslab/assets/blob/main/execute-pipeline-button.png?raw=True)
...
[Slack](https://www.bigbytes.ai/chat).
