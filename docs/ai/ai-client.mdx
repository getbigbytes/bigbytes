...
[the capabilities of Bigbytes](https://docs.bigbytes.ai/guides/ai/overview), as detailed in the
...
This is an [example PR](https://github.com/digitranslab/bigbytes/pull/3850).

### Create new AI config

Create a dedicated configuration to save the params required to connect to LLM in the [config.py](https://github.com/digitranslab/bigbytes/blob/92c372b24e08148863d799d9afcdd44483c11c89/bigbytes/orchestration/ai/config.py#L19).
...
Inherit the [AIClient interface](https://github.com/digitranslab/bigbytes/blob/master/bigbytes/ai/ai_client.py)
...
The last action to take is modifying the Setup function within "[bigbytes/ai/llm_pipeline_wizard.py](https://github.com/digitranslab/bigbytes/blob/92c372b24e08148863d799d9afcdd44483c11c89/bigbytes/ai/llm_pipeline_wizard.py#L195)"
