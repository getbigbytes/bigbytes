...
<Warning>
  ...
  will be stored in the Bigbytes data folder which by default will be created at `~/.mage_data`. If
...
![Create Secrets](https://github.com/digitranslab/assets/blob/main/create-secrets.png?raw=True)
...
![Using Secrets](https://github.com/digitranslab/assets/blob/main/using-secrets.png?raw=True)
