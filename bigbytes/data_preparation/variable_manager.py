...
from bigbytes.data.models.generator import DataGenerator
from bigbytes.data.tabular.models import BatchSettings
from bigbytes.data_preparation.models.utils import (
    infer_variable_type,
    warn_for_repo_path,
)
from bigbytes.data_preparation.models.variable import VARIABLE_DIR, Variable
...
from bigbytes.settings.repo import get_repo_path, get_variables_dir
from bigbytes.settings.server import MEMORY_MANAGER_V2
from bigbytes.shared.constants import GCS_PREFIX, S3_PREFIX
from bigbytes.shared.dates import str_to_timedelta
...
class S3VariableManager(VariableManager):
    def __init__(self, repo_path=None, variables_dir=None):
        ...
        from bigbytes.data_preparation.storage.s3_storage import S3Storage
...
class GCSVariableManager(VariableManager):
    def __init__(self, repo_path=None, variables_dir=None):
        super().__init__(repo_path=repo_path, variables_dir=variables_dir)
        from bigbytes.data_preparation.storage.gcs_storage import GCSStorage
