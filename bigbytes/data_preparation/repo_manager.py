...
from bigbytes.settings.repo import get_repo_name as get_repo_name_new
from bigbytes.settings.repo import get_repo_path as get_repo_path_new
from bigbytes.settings.repo import get_variables_dir
from bigbytes.settings.repo import set_repo_path as set_repo_path_new
...
from bigbytes.shared.yaml import load_yaml, trim_strings
...
class RepoConfig:
    ...
    def pipelines(self, pipelines: Dict = None) -> None:
        from bigbytes.data_preparation.models.project.models import ProjectPipelines
...
def get_repo_path() -> str:
    warn(
        'repo_manager.get_repo_path is deprecated. Please use bigbytes.settings.repo.get_repo_path',
        DeprecationWarning,
        stacklevel=2,
    )
...
def set_repo_path(repo_path: str) -> None:
    warn(
        'repo_manager.set_repo_path is deprecated. Please use bigbytes.settings.repo.set_repo_path',
        DeprecationWarning,
        stacklevel=2,
    )
...
def get_repo_name() -> str:
    warn(
        'repo_manager.get_repo_name is deprecated. Please use bigbytes.settings.repo.get_repo_name',
        DeprecationWarning,
        stacklevel=2,
    )
...
def get_data_dir() -> str:
    warn(
        'repo_manager.get_data_dir is deprecated. Please use bigbytes.settings.repo.get_data_dir',
        DeprecationWarning,
        stacklevel=2,
    )
