...
from bigbytes.cache.dbt.constants import IGNORE_DIRECTORY_NAMES
...
from bigbytes.shared.files import exists_async, rename_async, write_async
from bigbytes.shared.path_fixer import remove_base_repo_path_or_name
from bigbytes.shared.utils import get_absolute_path
...
class File:
    ...
    def validate_content(self, dir_path, filename, content):
        if dir_path.startswith(PIPELINES_FOLDER_PREFIX) and filename == 'triggers.yaml':
            from bigbytes.data_preparation.models.triggers import load_trigger_configs
