...
from bigbytes.data_preparation.models.block.utils import fetch_input_variables
from bigbytes.data_preparation.models.global_hooks.constants import (
    GLOBAL_HOOKS_FILENAME,
    RESOURCE_TYPES,
    HookOutputKey,
)
from bigbytes.data_preparation.models.global_hooks.predicates import HookPredicate
from bigbytes.data_preparation.models.global_hooks.utils import extract_valid_data
...
from bigbytes.orchestration.triggers.constants import TRIGGER_NAME_FOR_GLOBAL_HOOK
...
from bigbytes.shared.multi import run_parallel_multiple_args
