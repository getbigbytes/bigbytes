...
from bigbytes.data.constants import InputDataType, VariableType
from bigbytes.data.models.manager import DataManager
from bigbytes.data.tabular.models import BatchSettings
from bigbytes.data.tabular.reader import read_metadata
from bigbytes.data_cleaner.shared.utils import is_geo_dataframe, is_spark_dataframe
...
from bigbytes.data_preparation.models.utils import (  # dask_from_pandas,
...
from bigbytes.data_preparation.models.variables.summarizer import get_part_uuids
from bigbytes.data_preparation.storage.base_storage import BaseStorage
...
from bigbytes.shared.array import is_iterable
from bigbytes.shared.environments import is_debug
from bigbytes.shared.hash import flatten_dict
from bigbytes.shared.outputs import load_custom_object, save_custom_object
from bigbytes.shared.parsers import deserialize_matrix, sample_output, serialize_matrix
...
from bigbytes.system.storage.utils import size_of_path
...
class Variable:
    ...
    def __read_polars_parquet(
        ...
        if self.storage.path_exists(column_types_filename):
            column_types = self.storage.read_json_file(column_types_filename)
            # No Bigbytes specific code to serialize columns for polars when writing a variable,
    ...
    def __memory_manager_v2_enabled(self):
        from bigbytes.settings.server import MEMORY_MANAGER_V2
