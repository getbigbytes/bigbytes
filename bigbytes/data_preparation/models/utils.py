...
from bigbytes.settings.platform.constants import user_project_platform_activated
from bigbytes.shared.complex import is_model_sklearn, is_model_xgboost
from bigbytes.shared.hash import unflatten_dict
...
def infer_variable_type(
    ...
    if isinstance(data, pl.DataFrame) or (
        ...
        from bigbytes.settings.server import MEMORY_MANAGER_POLARS_V2, MEMORY_MANAGER_V2
