...
import bigbytes.data_preparation.decorators
from bigbytes.cache.block import BlockCache
from bigbytes.data.constants import InputDataType
from bigbytes.data.tabular.models import BatchSettings
from bigbytes.data_integrations.sources.constants import SQL_SOURCES_MAPPING
from bigbytes.data_preparation.logging.logger import DictLogger
from bigbytes.data_preparation.logging.logger_manager_factory import LoggerManagerFactory
from bigbytes.data_preparation.models.block.content import hydrate_block_outputs
from bigbytes.data_preparation.models.block.data_integration.mixins import (
    DataIntegrationMixin,
)
from bigbytes.data_preparation.models.block.data_integration.utils import (
    execute_data_integration,
)
from bigbytes.data_preparation.models.block.dynamic.utils import (
    is_dynamic_block,
    is_dynamic_block_child,
    should_reduce_output,
    uuid_for_output_variables,
)
from bigbytes.data_preparation.models.block.dynamic.variables import (
    LazyVariableSet,
...
from bigbytes.data_preparation.models.block.errors import HasDownstreamDependencies
from bigbytes.data_preparation.models.block.extension.utils import handle_run_tests
from bigbytes.data_preparation.models.block.outputs import (
    format_output_data,
    get_outputs_for_display_async,
    get_outputs_for_display_dynamic_block,
    get_outputs_for_display_sync,
)
from bigbytes.data_preparation.models.block.platform.mixins import (
    ProjectPlatformAccessible,
)
from bigbytes.data_preparation.models.block.platform.utils import from_another_project
from bigbytes.data_preparation.models.block.settings.dynamic.mixins import DynamicMixin
from bigbytes.data_preparation.models.block.settings.global_data_products.mixins import (
    GlobalDataProductsMixin,
)
from bigbytes.data_preparation.models.block.settings.variables.mixins import (
    VariablesMixin,
)
from bigbytes.data_preparation.models.block.settings.variables.models import (
    ChunkKeyTypeUnion,
)
from bigbytes.data_preparation.models.block.spark.mixins import SparkBlock
from bigbytes.data_preparation.models.block.utils import (
    clean_name,
...
from bigbytes.data_preparation.models.utils import is_basic_iterable, warn_for_repo_path
from bigbytes.data_preparation.models.variable import Variable
from bigbytes.data_preparation.models.variables.cache import (
    AggregateInformation,
    AggregateInformationData,
    InformationData,
    VariableAggregateCache,
)
from bigbytes.data_preparation.models.variables.constants import (
    VariableAggregateDataType,
    VariableAggregateSummaryGroupType,
    VariableType,
)
from bigbytes.data_preparation.models.variables.summarizer import (
    aggregate_summary_info_for_all_variables,
    get_aggregate_summary_info,
)
from bigbytes.data_preparation.repo_manager import RepoConfig
from bigbytes.data_preparation.shared.stream import StreamToLogger
from bigbytes.data_preparation.shared.utils import get_template_vars
from bigbytes.data_preparation.templates.data_integrations.utils import get_templates
from bigbytes.data_preparation.templates.template import load_template
from bigbytes.data_preparation.variable_manager import VariableManager
from bigbytes.io.base import ExportWritePolicy
from bigbytes.services.spark.config import SparkConfig
from bigbytes.services.spark.spark import SPARK_ENABLED, get_spark_session
from bigbytes.settings.platform.constants import project_platform_activated
from bigbytes.settings.repo import base_repo_path_directory_name, get_repo_path
from bigbytes.settings.server import VARIABLE_DATA_OUTPUT_META_CACHE
from bigbytes.shared.array import is_iterable, unique_by
from bigbytes.shared.constants import ENV_DEV, ENV_TEST
from bigbytes.shared.custom_logger import DX_PRINTER
from bigbytes.shared.environments import get_env, is_debug
from bigbytes.shared.hash import extract, ignore_keys, merge_dict
from bigbytes.shared.logger import BlockFunctionExec
from bigbytes.shared.parsers import encode_complex
from bigbytes.shared.path_fixer import (
    add_absolute_path,
    add_root_repo_path_to_relative_path,
    get_path_parts,
    remove_base_repo_path,
)
from bigbytes.shared.strings import format_enum
from bigbytes.shared.utils import clean_name as clean_name_orig
from bigbytes.shared.utils import is_spark_env

# from bigbytes.system.memory.manager import MemoryManager
from bigbytes.system.memory.wrappers import execute_with_memory_tracking
from bigbytes.system.models import ResourceUsage
...
class Block(
    ...
    def full_table_name(self) -> Optional[str]:
        from bigbytes.data_preparation.models.block.sql.utils.shared import (
        ...
        def __execute(
            ...
            try:
                ...
                if output_messages_to_logs and not logger:
                    from bigbytes.data_preparation.models.block.constants import (
    ...
    def execute_block_function(
        ...
        from bigbytes.settings.server import (
    ...
    def __initialize_decorator_modules(
        ...
        for module_name in decorator_module_names:
            ...
            setattr(
                module,
                module_name,
                getattr(bigbytes.data_preparation.decorators, module_name),
            )

        module.test = bigbytes.data_preparation.decorators.test
    ...
    def analyze_outputs(
        ...
        for uuid, data in variable_mapping.items():
            if isinstance(data, pd.DataFrame):
                ...
                try:
                    from bigbytes.data_cleaner.data_cleaner import clean as clean_data
    ...
    def __update_name(
        ...
        if self.pipeline is not None:
            ...
            cache = BlockCache()
            if detach:
                from bigbytes.data_preparation.models.block.block_factory import (
                    BlockFactory,
                )
