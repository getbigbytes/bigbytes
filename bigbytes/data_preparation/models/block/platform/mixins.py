...
from bigbytes.cache.dbt.utils import get_project_path_from_file_path
from bigbytes.data_preparation.models.block.platform.utils import (
...
class ProjectPlatformAccessible:
    ...
    def get_project_path_from_project_name(self, project_name: str) -> str:
        ...
        if not project_name:
            from bigbytes.data_preparation.models.block.dbt.constants import (
                DBT_DIRECTORY_NAME,
            )
