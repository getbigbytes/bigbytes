...
from bigbytes.data_preparation.models.block.dbt.constants import LogLevel
from bigbytes.data_preparation.models.block.dbt.dbt_cli import DBTCli
from bigbytes.data_preparation.models.block.dbt.profiles import Profiles
from bigbytes.data_preparation.models.block.dbt.project import Project
from bigbytes.data_preparation.models.block.dbt.utils import (
    get_source_name,
...
from bigbytes.orchestration.constants import PIPELINE_RUN_BIGBYTES_VARIABLES_KEY
from bigbytes.settings.utils import base_repo_path
from bigbytes.shared.files import find_file_from_another_file_path
from bigbytes.shared.hash import merge_dict
from bigbytes.shared.path_fixer import add_absolute_path
from bigbytes.shared.strings import remove_extension_from_filename
    ...
    def _execute_block(
        ...
        **kwargs,
        ...
        runtime_configuration = variables.get(
            PIPELINE_RUN_BIGBYTES_VARIABLES_KEY,
            {},
