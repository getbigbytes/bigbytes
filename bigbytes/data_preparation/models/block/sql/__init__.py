...
from bigbytes.data_preparation.models.block.sql import (
    bigquery,
    clickhouse,
    druid,
    duckdb,
...
from bigbytes.io.base import QUERY_ROW_LIMIT, DataSource, ExportWritePolicy
...
def execute_sql_code(
    ...
    if DataSource.BIGQUERY.value == data_provider:
        ...
        from bigbytes.io.trino import Trino
