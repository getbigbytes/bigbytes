...
from bigbytes.data_preparation.models.block.dynamic.data import (
    calculate_dynamic_index_data_index,
)
from bigbytes.data_preparation.models.block.settings.variables.models import (
    ChunkKeyTypeUnion,
)
from bigbytes.data_preparation.models.constants import BlockLanguage, BlockType
from bigbytes.data_preparation.models.variable import Variable
from bigbytes.data_preparation.models.variables.utils import (
    get_first_data_output_variable,
)
from bigbytes.io.base import ExportWritePolicy
from bigbytes.settings.server import DEBUG_MEMORY, MEMORY_MANAGER_V2
from bigbytes.shared.environments import is_debug, is_test
from bigbytes.shared.strings import to_ordinal_integers
...
class LazyVariable:
    ...
    @property
    def is_dynamic(self):
        from bigbytes.data_preparation.models.block.dynamic.utils import is_dynamic_block
...
def dynamic_upstream_block_item_counts(block, partition: Optional[str] = None) -> List[int]:
    from bigbytes.data_preparation.models.block.dynamic.counter import DynamicItemCounter
    from bigbytes.data_preparation.models.block.dynamic.utils import (
        is_dynamic_block,
