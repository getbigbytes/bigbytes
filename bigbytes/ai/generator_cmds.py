...
from bigbytes.ai.llm_pipeline_wizard import LLMPipelineWizard

app = typer.Typer()

PROJECT_NAME_DEFAULT = typer.Argument(
    ..., help='Bigbytes project path'
)
PIPELINE_NAME_DEFAULT = typer.Argument(
    ..., help='Bigbytes pipeline uuid'
)
BLOCK_NAME_DEFAULT = typer.Argument(
    ..., help='Bigbytes block uuid in the pipeline'
)
