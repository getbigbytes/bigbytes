from bigbytes.settings.backends import (
    AWSSecretsManagerBackend,
    BackendType,
    SettingsBackend,
)
from bigbytes.settings.server import *  # noqa: F401, F403
...
class Settings():
    ...
    def get_value(self, key: str, default: str = None) -> str:
        """
        Get the value of an environment variable. Add Bigbytes specific logic to handle fetching
