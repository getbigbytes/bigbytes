...
Make sure this value is the same in bigbytes/frontend/api/constants.ts
"""
...
BIGBYTES_CLUSTER_UUID = os.getenv('BIGBYTES_CLUSTER_UUID') or 'bigbytes'
...
# -----------------------------
# Bigbytes URL and PATH Settings
# -----------------------------
