...
from bigbytes.settings.constants import PROJECT_METADATA_FILENAME, REPO_PATH_ENV_VAR
from bigbytes.settings.platform.constants import set_project_platform_activated_flag
from bigbytes.settings.platform.utils import project_platform_activated
...
def get_variables_dir(
    ...
    if os.getenv(MAGE_DATA_DIR_ENV_VAR):
        ...
        if variables_dir is None:
            variables_dir = DEFAULT_BIGBYTES_DATA_DIR
