...
from bigbytes.settings.constants import PROJECT_METADATA_FILENAME
from bigbytes.settings.platform.constants import (  # noqa: F401
    LOCAL_PLATFORM_SETTINGS_FILENAME,
    PLATFORM_SETTINGS_FILENAME,
    platform_settings_full_path,
    project_platform_activated,
)
from bigbytes.settings.server import ENABLE_USER_PROJECTS
from bigbytes.settings.utils import base_repo_name, base_repo_path
from bigbytes.shared.array import find
from bigbytes.shared.hash import combine_into, dig, extract, merge_dict
...
def activate_project(project_name: str, user=None) -> None:
    ...
    if project_name:
        if user and ENABLE_USER_PROJECTS:
            ...
            from bigbytes.orchestration.db.models.utils import activate_project_for_user
...
def active_project_settings(
    ...
    if user and ENABLE_USER_PROJECTS:
        from bigbytes.orchestration.db.models.utils import get_active_project_for_user
