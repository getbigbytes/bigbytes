...
from bigbytes.orchestration.notification.config import (
    AlertOn,
    MessageTemplate,
    NotificationConfig,
)
from bigbytes.services.discord.discord import send_discord_message
from bigbytes.services.email.email import send_email
from bigbytes.services.google_chat.google_chat import send_google_chat_message
from bigbytes.services.opsgenie.opsgenie import send_opsgenie_alert
...
DEFAULT_MESSAGES = dict(
    ...
    failure=dict(
        title='Failed to run Bigbytes pipeline {pipeline_uuid}',
        summary=(
    ...
    passed_sla=dict(
        title='SLA missed for Bigbytes pipeline {{pipeline_uuid}}',
        summary=(
