...
from bigbytes.data_integrations.utils.scheduler import (
...
from bigbytes.data_preparation.models.constants import ExecutorType, PipelineType
...
from bigbytes.orchestration.concurrency import ConcurrencyConfig, OnLimitReached
...
from bigbytes.orchestration.job_manager import JobType, get_job_manager
from bigbytes.orchestration.metrics.pipeline_run import (
...
from bigbytes.orchestration.utils.resources import get_compute, get_memory
from bigbytes.server.logger import Logger
from bigbytes.settings import HOSTNAME
from bigbytes.settings.platform import (
    project_platform_activated,
    repo_path_from_database_query_to_project_repo_path,
)
from bigbytes.settings.platform.utils import get_pipeline_from_platform
...
from bigbytes.shared.dates import compare
from bigbytes.shared.environments import get_env
from bigbytes.shared.hash import index_by, merge_dict
...
def gen_pipeline_with_schedules_project_platform(
    ...
    """
    {
      '/home/src/repo/default_platform2/project1': {
        'test1': [
          <bigbytes.orchestration.db.models.schedules.PipelineSchedule object at 0xffff85a0ef80>,
        ],
      },
      '/home/src/repo/default_platform2/project2': {
        'test2_pipeline': [
          <bigbytes.orchestration.db.models.schedules.PipelineSchedule object at 0xffff85a0f190>,
        ],
      },
    }
    """
