...
from bigbytes.orchestration.db.errors import ValidationError
from bigbytes.orchestration.db.models.base import Base, BaseModel, classproperty
from bigbytes.orchestration.db.models.dynamic.controller import is_ready_to_process_data
from bigbytes.orchestration.db.models.schedules_project_platform import (
    BlockRunProjectPlatformMixin,
    PipelineRunProjectPlatformMixin,
    PipelineScheduleProjectPlatformMixin,
)
from bigbytes.orchestration.db.models.tags import Tag, TagAssociation
from bigbytes.server.kernel_output_parser import DataType
from bigbytes.settings.platform import project_platform_activated
from bigbytes.settings.repo import get_repo_path
from bigbytes.shared.constants import ENV_PROD
from bigbytes.shared.dates import compare
from bigbytes.shared.enum import StrEnum
from bigbytes.shared.hash import ignore_keys, index_by, merge_dict
...
class PipelineRun(PipelineRunProjectPlatformMixin, BaseModel):
        ...
        for block_run in self.initial_block_runs:
            ...
            if block and is_dynamic_block_child(block):
                ...
                if not block and metrics and metrics.get('hook'):
                    from bigbytes.data_preparation.models.block.hook.block import (
                        HookBlock,
                    )
                    from bigbytes.data_preparation.models.global_hooks.models import Hook
    ...
    def create_block_runs(self) -> List['BlockRun']:
        ...
        from bigbytes.data_preparation.models.global_hooks.pipelines import (
    ...
    def upsert_batch(self, event_matchers_payload):
        ...
        for event_matcher, ids in event_matchers_and_pipeline_schedule_ids:
            ...
            if event_matcher.event_type == EventMatcher.EventType.AWS_EVENT:
                from bigbytes.services.aws.events.events import update_event_rule_targets
