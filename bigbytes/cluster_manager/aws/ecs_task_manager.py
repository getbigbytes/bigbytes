...
from bigbytes.services.aws import get_aws_boto3_client
from bigbytes.services.aws.ecs.config import EcsConfig
from bigbytes.services.aws.ecs.ecs import list_services, list_tasks, run_task, stop_task
...
class EcsTaskManager:
    ...
    def create_task(self, name: str, task_definition: str, container_name: str):
        ...
        return run_task(f'bigbytes start {name}', ecs_config=ecs_config, wait_for_completion=False)
