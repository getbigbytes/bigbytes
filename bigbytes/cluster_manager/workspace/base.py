...
from bigbytes.cluster_manager.config import LifecycleConfig, WorkspaceConfig
from bigbytes.cluster_manager.constants import ClusterType
from bigbytes.cluster_manager.errors import WorkspaceExistsError
...
from bigbytes.orchestration.db.models.oauth import Permission, User
...
class Workspace(abc.ABC):
    ...
    def workspace_class_from_type(cls, cluster_type: ClusterType) -> 'Workspace':
        if cluster_type == ClusterType.K8S:
            from bigbytes.cluster_manager.workspace.kubernetes import KubernetesWorkspace

            return KubernetesWorkspace
        elif cluster_type == ClusterType.CLOUD_RUN:
            from bigbytes.cluster_manager.workspace.cloud_run import CloudRunWorkspace

            return CloudRunWorkspace
        elif cluster_type == ClusterType.ECS:
            from bigbytes.cluster_manager.workspace.ecs import EcsWorkspace
