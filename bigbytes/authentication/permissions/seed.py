...
from bigbytes.orchestration.db.models.oauth import Permission, Role, RolePermission, User
...
async def bootstrap_permissions(policy_names: str = None):
    ...
    for policy_name in policy_names:
        policy_class = getattr(
            importlib.import_module(f'bigbytes.api.policies.{policy_name}Policy'),
