...
from bigbytes.authentication.oauth.constants import (
    ACTIVE_DIRECTORY_CLIENT_ID as ACTIVE_DIRECTORY_BIGBYTES_CLIENT_ID,
)
from bigbytes.authentication.oauth.constants import ProviderName
from bigbytes.authentication.providers.oauth import OauthProvider
from bigbytes.authentication.providers.sso import SsoProvider
from bigbytes.authentication.providers.utils import get_base_url
...
class ADProvider(SsoProvider, OauthProvider):
    ...
    def get_auth_url_response(self, redirect_uri: str = None, **kwargs) -> Dict:
        ...
        can either just set the ACTIVE_DIRECTORY_DIRECTORY_ID which will use the Bigbytes application we
        set up in Azure. They can additionally set the ACTIVE_DIRECTORY_CLIENT_ID and
        ACTIVE_DIRECTORY_CLIENT_SECRET which will use their own Bigbytes application in Azure.
        """
