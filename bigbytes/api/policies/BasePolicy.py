...
from bigbytes.api.constants import AttributeOperationType, AttributeType
...
from bigbytes.server.api.constants import URL_PARAMETER_API_KEY
from bigbytes.services.tracking.metrics import increment
        ...
        if not self.parent_resource_attr and self.parent_model():
            ...
            self.parent_resource_attr = getattr(
                importlib.import_module(
                    'bigbytes.api.resources.{}Resource'.format(parent_model_class)),
