...
from bigbytes.services.compute.models import ComputeConnection, ComputeService
from bigbytes.services.spark.constants import ComputeServiceUUID
from bigbytes.services.ssh.aws.emr.models import SSHTunnel, create_tunnel
from bigbytes.services.ssh.aws.emr.utils import should_tunnel, tunnel
...
class ComputeConnectionResource(GenericResource):
    ...
    async def update(self, payload, **kwargs):
        ...
        if parent_model and isinstance(parent_model, ComputeService):
            if ComputeServiceUUID.AWS_EMR == parent_model.uuid:
                from bigbytes.services.compute.aws.steps import SetupStepUUID
