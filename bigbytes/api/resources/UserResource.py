...
from bigbytes.api.utils import get_access_for_roles
from bigbytes.authentication.oauth2 import encode_token, generate_access_token
from bigbytes.authentication.passwords import (
    create_bcrypt_hash,
    generate_salt,
    verify_password,
)
...
from bigbytes.orchestration.db.models.oauth import Permission, Role, User, UserRole
from bigbytes.shared.hash import extract, ignore_keys, index_by
...
def __load_permissions(resource):
    from bigbytes.api.resources.PermissionResource import PermissionResource
...
def __load_roles(resource):
    from bigbytes.api.resources.RoleResource import RoleResource
