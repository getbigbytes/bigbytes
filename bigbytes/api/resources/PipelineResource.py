...
from bigbytes.ai.constants import LLMUseCase
...
from bigbytes.api.resources.BlockResource import BlockResource
from bigbytes.api.resources.LlmResource import LlmResource
from bigbytes.authentication.operation_history.utils import (
...
from bigbytes.data_preparation.models.custom_templates.custom_pipeline_template import (
...
from bigbytes.orchestration.pipeline_scheduler import (
    PipelineScheduler,
    retry_pipeline_run,
)
from bigbytes.server.active_kernel import switch_active_kernel
from bigbytes.server.kernels import PIPELINE_TO_KERNEL_NAME, KernelName
from bigbytes.settings.platform import project_platform_activated
from bigbytes.settings.platform.utils import get_pipeline_from_platform_async
from bigbytes.settings.repo import get_repo_path
from bigbytes.shared.array import find, find_index
from bigbytes.shared.hash import group_by, ignore_keys, merge_dict
from bigbytes.shared.strings import is_number
...
class PipelineResource(BaseResource):
    ...
    async def collection(self, query, meta, user, **kwargs):
        ...
        if from_history_days is not None and is_number(from_history_days):
            ...
            from bigbytes.cache.tag import NO_TAGS_QUERY, TagCache
