...
from bigbytes.orchestration.db.models.tags import (
    Tag,
    TagAssociation,
    ...
    def create(self, payload, user, **kwargs):
        ...
        if pipeline.should_save_trigger_in_code_automatically():
            ...
            def _callback(resource, kwargs=kwargs, user=user):
                from bigbytes.api.resources.PipelineTriggerResource import (
...
def __load_tag_associations(resource):
    from bigbytes.api.resources.TagResource import TagResource
