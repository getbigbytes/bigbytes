...
from bigbytes.api.mixins.result_set import ResultSetMixIn
from bigbytes.api.resources.Resource import Resource
from bigbytes.api.resources.shared import collective_loaders
...
class BaseResource(Resource, ResultSetMixIn):
    ...
    #     bigbytes.api.operations.constants.COOKIE_PREFIX + <cookie_name>
    cookie_names = []
    model_class = None
    child_resource_attr = {}
    parent_models_attr = {}
    ...
    def parser_class(cls):
        ...
        module_name = f'bigbytes.api.parsers.{model_name}Parser'
    ...
    def policy_class(cls):
        model_name = cls.model_name()
        return getattr(
            importlib.import_module('bigbytes.api.policies.{}Policy'.format(model_name)),
    ...
    def presenter_class(cls):
        model_name = cls.model_name()
        return getattr(
            importlib.import_module('bigbytes.api.presenters.{}Presenter'.format(model_name)),
