...
from bigbytes.data_preparation.models.global_hooks.constants import RESOURCE_TYPES
from bigbytes.data_preparation.models.global_hooks.models import HookOperation
