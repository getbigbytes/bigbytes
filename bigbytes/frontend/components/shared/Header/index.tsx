...
import Bigbytes8Bit from '@oracle/icons/custom/Bigbytes8Bit';
          ...
          <Flex alignItems="center">
            ...
            {latestVersion && version && latestVersion !== version && (
              <Button
                ...
                compact
                linkProps={{
                  href: 'https://docs.bigbytes.io/about/releases',
                }}
                noHoverUnderline
                pill
                sameColorAsText
            ...
            {version && typeof(version) !== 'undefined' && (
              <Spacing px={1}>
                <Link
                  href="https://www.bigbytes.io/changelog"
                  monospace
                  noWrapping
                  openNewWindow
                  sameColorAsText
