...
from bigbytes.shared.parsers import convert_matrix_to_dataframe
...
`,
  ...
  },
  {
    ...
    widgetTemplate: ({ block }) => ({
      ...
      content: `from bigbytes.data_preparation.models.constants import DATAFRAME_ANALYSIS_MAX_COLUMNS
from bigbytes.shared.parsers import convert_matrix_to_dataframe
...
`,
  ...
  },
  {
    ...
    widgetTemplate: ({ block }) => ({
      ...
      content: `from bigbytes.data_cleaner.column_types.column_type_detector import infer_column_types
...
from bigbytes.data_preparation.models.constants import DATAFRAME_ANALYSIS_MAX_COLUMNS
from bigbytes.shared.parsers import convert_matrix_to_dataframe
