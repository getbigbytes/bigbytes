...
export const COMPUTE_SERVICES: {
...
}[] = [
  {
    ...
    documentationHref: 'https://docs.bigbytes.io/integrations/spark-pyspark#standalone-spark-cluster',
  ...
  },
  {
    ...
    documentationHref: 'https://docs.bigbytes.io/integrations/spark-pyspark#aws',
