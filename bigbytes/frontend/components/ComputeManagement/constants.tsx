...
export const COMPUTE_SERVICES: {
...
}[] = [
  {
    ...
    documentationHref: 'https://docs.bigbytes.ai/integrations/spark-pyspark#standalone-spark-cluster',
  ...
  },
  {
    ...
    documentationHref: 'https://docs.bigbytes.ai/integrations/spark-pyspark#aws',
