...
export const GIT_FIELDS = [
  ...
  },
  {
    ...
    labelDescription: "Defaults to Python's os.getcwd() if omitted. Bigbytes will create this local directory if it doesn't already exist.",
    uuid: 'repo_path',
  },
];
...
export const HTTPS_GIT_FIELDS = [
  ...
  },
  {
    ...
    label: 'Access token',
    labelDescription: 'Add your Git access token to authenticate with your provided username. The access token will be stored as a Bigbytes secret. You will see the secret below if you have already added it.',
    required: true,
    type: 'password',
    uuid: 'access_token',
  },
