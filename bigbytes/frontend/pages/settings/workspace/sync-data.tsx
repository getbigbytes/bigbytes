...
function SyncData() {
              ...
              description = (
                <Spacing mb={1}>
                  <Text small>
                    ...
                    </Link> in terminal to get base64 encoded public key and paste the result here. The key will be stored as a Bigbytes secret. You will see the secret below if you have already added it.
                  </Text>
                </Spacing>
              );
              ...
              description = (
                <Spacing mb={1}>
                  <Text small>
                    ...
                    </Link> instead. The key will be stored as a Bigbytes secret. You will see the secret below if you have already added it.
                  </Text>
                </Spacing>
              );
            } else {
  ...
  const gitIntegrationFields = useMemo(() => (
    <>
      ...
      <Spacing mt={UNITS_BETWEEN_ITEMS_IN_SECTIONS}>
        <Text>
          These fields are required to help Bigbytes configure your Git settings. These settings
        ...
        {showSyncOperations && (
          <Spacing mt={UNITS_BETWEEN_SECTIONS}>
            ...
            <Spacing mt={1}>
              ...
              <Spacing mt={2} />
              <Text>
                Reset will tell Bigbytes to try to clone your repository from remote. This will
