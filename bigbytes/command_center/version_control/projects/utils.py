...
from bigbytes.api.policies.FilePolicy import FilePolicy
from bigbytes.api.resources.VersionControlProjectResource import (
...
from bigbytes.data_preparation.sync import AuthType
from bigbytes.presenters.interactions.constants import InteractionInputType
from bigbytes.version_control.models import Project
...
async def build_update(factory, model: Project, items: List[Dict]):
    ...
    shared_form_settings = [
        ...
        dict(
            ...
            placeholder='e.g. https://github.com/digitranslab/bigbytes.git',
            value=sync_config.get('remote_repo_link'),
        ),
        dict(
            label='Local directory path',
            description=(
                'Defaults to Python’s os.getcwd() if omitted. Bigbytes will create '
    ...
    shared_form_settings_ssh = [
        dict(
            ...
            description=(
                ...
                'here. The key will be stored as a Bigbytes secret.'
            ),
            display_settings=dict(
                icon_uuid='Secrets',
            ),
        ...
        dict(
            ...
            description=(
                ...
                'instead. The key will be stored as a Bigbytes secret.'
            ),
            display_settings=dict(
                icon_uuid='Secrets',
            ),
        ...
        dict(
            ...
            description=(
                ...
                'The access token will be stored as a Bigbytes secret.'
            ),
            display_settings=dict(
                icon_uuid='Secrets',
            ),
            ...
            dict(
                ...
                settings=copy.deepcopy(shared_form_settings) + [
                    dict(
                        label='Username',
                        description=(
                            'These fields are required to help Bigbytes configure your Git '
