...
class CustomActionTests(TestCase):
    def test_decorated_custom_action(self):
        ...
        action = dict(
            action_type='custom',
            axis='row',
            action_code='''from bigbytes.data_cleaner.column_types.column_type_detector \
            import infer_column_types
from bigbytes.data_cleaner.column_types.constants import ColumnType
from bigbytes.data_cleaner.transformer_actions.constants import CURRENCY_SYMBOLS
import pandas as pd
import numpy as np
