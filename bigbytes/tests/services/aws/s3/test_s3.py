from bigbytes.services.aws.s3.s3 import Client
from bigbytes.tests.base_test import TestCase
from unittest.mock import MagicMock, patch


class ClientTests(TestCase):
    @patch('bigbytes.services.aws.s3.s3.boto3')
    @patch('bigbytes.services.aws.s3.s3.botocore')
    @patch('bigbytes.services.aws.s3.s3.s3transfer')
