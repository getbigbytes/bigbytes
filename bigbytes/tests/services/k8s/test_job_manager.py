...
from bigbytes.services.k8s.job_manager import (
    JobManager,
    filter_used_volumes,
    merge_containers,
)
...
class JobManagerTests(TestCase):
    ...
    @patch('bigbytes.services.k8s.job_manager.client')
    @patch('bigbytes.services.k8s.job_manager.config')
    ...
    @patch('bigbytes.services.k8s.job_manager.client.CoreV1Api')
    @patch('bigbytes.services.k8s.job_manager.os.getenv')
