...
from bigbytes.api.resources.ProjectResource import ProjectResource, build_project
...
build_list_endpoint_tests(
    ...
    patch_function_settings=[
        ('bigbytes.api.resources.ProjectResource.project_platform_activated', lambda: True),
        ('bigbytes.api.resources.ProjectResource.ProjectResource.member', __member),
    ],
...
build_update_endpoint_tests(
    ...
    patch_function_settings=[
        ('bigbytes.api.resources.ProjectResource.activate_project',),
        ('bigbytes.data_preparation.models.project.project_platform_activated', lambda: True),
    ],
)
