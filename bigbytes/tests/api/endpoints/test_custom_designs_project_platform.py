...
from bigbytes.tests.shared.mixins import CustomDesignMixin, ProjectPlatformMixin

CURRENT_FILE_PATH = os.path.dirname(os.path.realpath(__file__))


@patch('bigbytes.presenters.design.models.project_platform_activated', lambda: True)
...
build_list_endpoint_tests(
    ...
    patch_function_settings=[
        ...
        ('bigbytes.presenters.design.models.project_platform_activated', lambda: True),
