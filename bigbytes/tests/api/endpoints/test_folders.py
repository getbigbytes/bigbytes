...
build_create_endpoint_tests(
    ...
    patch_function_settings=[
        ('bigbytes.data_preparation.models.file.project_platform_activated', lambda: True),
        ...
        ('bigbytes.api.resources.FolderResource.ensure_file_is_in_project', lambda _x: True),
    ],
)
