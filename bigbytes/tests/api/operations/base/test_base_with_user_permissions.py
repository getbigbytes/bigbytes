...
from bigbytes.tests.api.operations.base.mixins import Base
...
#         with patch('bigbytes.api.policies.BasePolicy.REQUIRE_USER_AUTHENTICATION', 1):
#             with patch('bigbytes.api.policies.BasePolicy.REQUIRE_USER_PERMISSIONS', 1):
