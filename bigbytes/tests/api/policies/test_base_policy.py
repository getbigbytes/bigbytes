...
from bigbytes.api.resources.UserResource import UserResource
...
class BasePolicyTest(BaseApiTestCase, BootstrapMixin):
    ...
    def test_is_owner(self):
        ...
        with patch('bigbytes.api.policies.BasePolicy.is_owner') as mock:
    ...
    def test_has_at_least_admin_role(self):
        ...
        with patch('bigbytes.api.policies.BasePolicy.has_at_least_admin_role') as mock:
            mock.return_value = True
    ...
    def test_has_at_least_editor_role(self):
        ...
        with patch('bigbytes.api.policies.BasePolicy.has_at_least_editor_role') as mock:
            mock.return_value = True
    ...
    def test_has_at_least_editor_role_and_notebook_edit_access(self):
        ...
        with patch(
            'bigbytes.api.policies.BasePolicy.has_at_least_editor_role_and_notebook_edit_access',
        ) as mock:
            mock.return_value = True
    ...
    def test_has_at_least_editor_role_and_pipeline_edit_access(self):
        ...
        with patch(
            'bigbytes.api.policies.BasePolicy.has_at_least_editor_role_and_pipeline_edit_access',
        ) as mock:
            mock.return_value = True
    ...
    def test_has_at_least_viewer_role(self):
        ...
        with patch('bigbytes.api.policies.BasePolicy.has_at_least_viewer_role') as mock:
            mock.return_value = True
...
class BasePolicyWithoutUserAuthenticationTest(BaseApiTestCase, BootstrapMixin):
    ...
    @patch('bigbytes.api.policies.BasePolicy.DISABLE_NOTEBOOK_EDIT_ACCESS', 0)
    ...
    @patch('bigbytes.api.policies.BasePolicy.DISABLE_NOTEBOOK_EDIT_ACCESS', 0)
    @patch('bigbytes.api.utils.DISABLE_NOTEBOOK_EDIT_ACCESS', 0)
    ...
    @patch('bigbytes.api.policies.BasePolicy.DISABLE_NOTEBOOK_EDIT_ACCESS', 2)
    @patch('bigbytes.api.utils.is_disable_pipeline_edit_access')
    ...
    @patch('bigbytes.api.policies.BasePolicy.DISABLE_NOTEBOOK_EDIT_ACCESS', 2)
    @patch('bigbytes.api.utils.DISABLE_NOTEBOOK_EDIT_ACCESS', 2)
    @patch('bigbytes.api.utils.is_disable_pipeline_edit_access')
