...
from bigbytes.api.constants import (
...
for entity_name in [
    ...
    for operation in operations:
        ...
        setattr(
            ...
            method_name,
            patch(
                'bigbytes.api.policies.mixins.user_permissions.DISABLE_NOTEBOOK_EDIT_ACCESS',
                0,
            )(build_test_action(
        ...
        setattr(
            ...
            method_name,
            patch(
                'bigbytes.api.policies.mixins.user_permissions.is_disable_pipeline_edit_access',
                lambda: False,
            )(build_test_action(
                access=Permission.add_accesses([
                    PermissionAccess.DISABLE_UNLESS_CONDITIONS,
