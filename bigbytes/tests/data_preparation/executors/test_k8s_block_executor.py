...
from bigbytes.data_preparation.executors.k8s_block_executor import K8sBlockExecutor
...
class K8sBlockExecutorTestCase(unittest.TestCase):
    ...
    @patch('bigbytes.data_preparation.executors.k8s_block_executor.K8sJobManager')
