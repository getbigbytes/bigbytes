...
from bigbytes.data_preparation.models.pipeline import InvalidPipelineError, Pipeline
...
from bigbytes.tests.factory import create_pipeline_run_with_schedule
...
class PipelineTest(AsyncDBTestCase):
    ...
    @patch('bigbytes.data_preparation.repo_manager.get_project_uuid')
...
def export_data(df, *args):
    ...
    def test_get_all_pipelines_all_projects(self):
        with patch('bigbytes.data_preparation.models.pipeline.Pipeline.get_all_pipelines') as mock:
