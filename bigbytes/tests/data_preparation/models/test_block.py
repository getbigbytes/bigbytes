...
# from bigbytes.data_cleaner.column_types.constants import ColumnType
from bigbytes.data_preparation.models.block import Block, BlockType, CallbackBlock
...
from bigbytes.tests.factory import (
...
#         with open(block.file_path, 'w') as file:
#             file.write("""
# CREATE TABLE bigbytes.users_v1 (
#     id BIGINT
# );
# """)
#         self.assertEqual(get_block().full_table_name, 'bigbytes.users_v1')
...
# SELECT 1 AS id;
# """)
#         self.assertEqual(get_block().full_table_name, 'bigbytes.users_v2')
...
# INSERT INTO bigbytes.users_v3
# SELECT 1 AS id;
# """)
#         self.assertEqual(get_block().full_table_name, 'bigbytes.users_v3')

#         with open(block.file_path, 'w') as file:
#             file.write("""
# INSERT bigbytes.users_v2
# SELECT 1 AS id;
# """)
#         self.assertEqual(get_block().full_table_name, 'bigbytes.users_v2')
...
#         with open(block.file_path, 'w') as file:
#             file.write("""
# INSERT OVERWRITE INTO bigbytes.users_v2
# SELECT 1 AS id;
# """)
#         self.assertEqual(get_block().full_table_name, 'bigbytes.users_v2')
...
class BlockProjectPlatformTests(ProjectPlatformMixin):
    def test_file_path(self):
        ...
        with patch(
            ...
            with patch(
                'bigbytes.data_preparation.models.block.platform.mixins.project_platform_activated',
                lambda: True,
            ):
                block = Block.create(
                    'test_transformer',
