...
from bigbytes.tests.factory import build_pipeline_with_blocks_and_content
...
class GlobalHooksTest(BaseApiTestCase):
    ...
    @patch('bigbytes.data_preparation.models.global_hooks.models.run_hooks')
...
class GlobalHooksProjectPlatformTest(ProjectPlatformMixin, BaseApiTestCase):
    def test_load_from_file(self):
        with patch(
            'bigbytes.data_preparation.models.global_hooks.models.project_platform_activated',
            lambda: True,
        ):
