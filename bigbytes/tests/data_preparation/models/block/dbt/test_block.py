...
class DBTBlockTest(AsyncDBTestCase):
    ...
    # @patch('bigbytes.data_preparation.models.block.dbt.block.Profiles')
    # @patch('bigbytes.data_preparation.models.block.dbt.block.Project')
    # @patch('bigbytes.data_preparation.models.block.dbt.block.Sources')
    # @patch('bigbytes.data_preparation.models.block.dbt.block.DBTAdapter')
