...
from bigbytes.data_preparation.templates.template import (
...
class TemplateTest(TestCase):
    def test_template_creation(self):
        ...
        expected_string = """from bigbytes.data_cleaner.transformer_actions.base import BaseAction
from bigbytes.data_cleaner.transformer_actions.constants import ActionType, Axis
...
"""
    ...
    def test_template_generation_data_loader_specific(self):
        redshift_template = """from bigbytes.settings.repo import get_repo_path
...
def test_output(output, *args) -> None:
    ...
    assert output is not None, 'The output is undefined'
"""
        s3_template = """from bigbytes.settings.repo import get_repo_path
from bigbytes.io.config import ConfigFileLoader
...
"""
    ...
    def test_template_generation_transformer_action_simple(self):
        expected_template = """from bigbytes.data_cleaner.transformer_actions.base import BaseAction
from bigbytes.data_cleaner.transformer_actions.constants import ActionType, Axis
from bigbytes.data_cleaner.transformer_actions.utils import build_transformer_action
...
"""
    ...
    def test_template_generation_data_exporter_specific(self):
        bigquery_template = """from bigbytes.settings.repo import get_repo_path
...
"""
        snowflake_template = """from bigbytes.settings.repo import get_repo_path
from bigbytes.io.config import ConfigFileLoader
...
"""
    ...
    def test_template_generation_transformer_dwh(self):
        postgres_template = """from bigbytes.settings.repo import get_repo_path
from bigbytes.io.config import ConfigFileLoader
