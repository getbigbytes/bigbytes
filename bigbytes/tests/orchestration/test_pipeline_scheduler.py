...
from bigbytes.orchestration.backfills.service import start_backfill
...
from bigbytes.orchestration.job_manager import JobManager, JobType
...
class PipelineSchedulerTests(DBTestCase):
    ...
    @patch('bigbytes.orchestration.pipeline_scheduler_original.run_block')
    @patch('bigbytes.orchestration.pipeline_scheduler_original.get_job_manager')
    ...
    @patch('bigbytes.orchestration.pipeline_scheduler_original.run_pipeline')
    @patch('bigbytes.orchestration.pipeline_scheduler_original.get_job_manager')
    ...
    @freeze_time('2023-05-01 01:20:33')
    @patch('bigbytes.orchestration.utils.git.GitSync')
