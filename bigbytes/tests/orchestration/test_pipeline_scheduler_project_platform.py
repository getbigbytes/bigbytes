...
from bigbytes.data_preparation.models.triggers import ScheduleStatus, ScheduleType
...
@patch(
    'bigbytes.orchestration.pipeline_scheduler_original.project_platform_activated',
    lambda: True,
)
@patch(
...
class PipelineSchedulerProjectPlatformTests(ProjectPlatformMixin, DBTestCase):
    ...
    def test_run_block(self):
        with patch(
            ...
            with patch(
                'bigbytes.orchestration.pipeline_scheduler_original.'
    ...
    def test_check_sla(self):
        ...
        with patch(
            'bigbytes.orchestration.pipeline_scheduler_original.PipelineRun',
            PipelineRunMock,
        ):
            with patch(
                'bigbytes.data_preparation.models.pipeline.project_platform_activated',
