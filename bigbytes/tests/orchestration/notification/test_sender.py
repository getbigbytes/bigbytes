...
from bigbytes.tests.factory import create_pipeline, create_pipeline_run_with_schedule
from bigbytes.tests.orchestration.notification.constants import (
...
class NotificationSenderTests(DBTestCase):
    ...
    @patch('bigbytes.orchestration.notification.sender.send_slack_message')
    @patch('bigbytes.orchestration.notification.sender.send_email')
    ...
    def test_send_pipeline_run_failure_message(self, mock_send_email, mock_send_slack):
        ...
        title = 'Failed to run Bigbytes pipeline test_pipeline'
    ...
    @patch('bigbytes.orchestration.notification.sender.send_teams_message')
    @patch('bigbytes.orchestration.notification.sender.send_email')
    ...
    @patch('bigbytes.orchestration.notification.sender.send_opsgenie_alert')
    @patch('bigbytes.orchestration.notification.sender.send_email')
