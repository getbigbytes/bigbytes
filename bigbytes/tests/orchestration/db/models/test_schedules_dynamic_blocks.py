...
from bigbytes.data_preparation.models.block.settings.dynamic.constants import ModeType
...
from bigbytes.tests.factory import create_pipeline_run
...
class PipelineRunWithDynamicBlocksTests(BlockHelperTest):
    ...
    @patch.multiple('bigbytes.settings.server', DYNAMIC_BLOCKS_V2=True)
