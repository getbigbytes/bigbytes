from bigbytes.io.config import ConfigFileLoader, ConfigKey, EnvironmentVariableLoader
...
"""
    ...
    @mock.patch('bigbytes.io.config.os')
    ...
    @mock.patch('bigbytes.data_preparation.shared.utils.os')
