...
from bigbytes.io.base import BaseFile, FileFormat, QUERY_ROW_LIMIT
...
class AzureBlobStorage(BaseFile):
    """
    Handles data transfer between an Azure Blob Storage container and the Bigbytes app. Supports
