...
from bigbytes.api.utils import authenticate_client_and_token, has_at_least_editor_role
from bigbytes.data_preparation.models.errors import FileNotInProjectError
from bigbytes.data_preparation.models.file import ensure_file_is_in_project
    ...
    def __initialize_terminal(self, term_name: str, cwd: str = None):
        ...
        if self.term_command == 'bash':
            self.terminal.ptyproc.write(
                "bind 'set enable-bracketed-paste off' # Bigbytes terminal settings command\r")
