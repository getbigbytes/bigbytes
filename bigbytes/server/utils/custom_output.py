...
def __custom_output():
    ...
    from bigbytes.ai.utils.xgboost import create_tree_visualization
    ...
    from bigbytes.data_preparation.models.block.outputs import format_output_data
    ...
    from bigbytes.data_preparation.models.variable import VariableType
    from bigbytes.presenters.utils import render_output_tags
