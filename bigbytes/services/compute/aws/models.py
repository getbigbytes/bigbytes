...
from bigbytes.server.active_kernel import restart_kernel, start_kernel
from bigbytes.services.aws.emr.emr import list_clusters
from bigbytes.services.compute.aws.constants import (
    CONNECTION_CREDENTIAL_AWS_ACCESS_KEY_ID,
    CONNECTION_CREDENTIAL_AWS_SECRET_ACCESS_KEY,
    INVALID_STATES,
    ClusterStatusState,
)
from bigbytes.services.compute.aws.steps import build_connections, build_steps
from bigbytes.services.compute.models import (
    ComputeConnection,
    ComputeService,
...
from bigbytes.services.ssh.aws.emr.utils import cluster_info_from_tunnel
...
class Cluster(BaseDataClass):
    ...
    name: str = None  # 2023-11-09T07:23:39.142404-bigbytes-data-preparation
...
class AWSEMRComputeService(ComputeService):
    ...
    def activate_cluster(self, cluster_id: str = None, discover: bool = False, **kwargs) -> Cluster:
        from bigbytes.cluster_manager.aws.emr_cluster_manager import emr_cluster_manager
    ...
    def terminate_clusters(self, cluster_ids: List[str]) -> None:
        # from bigbytes.cluster_manager.aws.emr_cluster_manager import emr_cluster_manager
        from bigbytes.services.aws.emr.emr import terminate_clusters

        terminate_clusters(cluster_ids)

        cluster_info = cluster_info_from_tunnel()
        if cluster_info and cluster_info.get('id') in cluster_ids:
            from bigbytes.services.ssh.aws.emr.models import close_tunnel
    ...
    def get_cluster_details(self, cluster_id, **kwargs) -> Union[Cluster, Dict]:
        from bigbytes.services.aws.emr.emr import describe_cluster
