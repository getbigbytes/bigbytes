...
from bigbytes.services.aws.emr.constants import SECURITY_GROUP_NAME_MASTER_DEFAULT
...
from bigbytes.services.compute.constants import (
    CUSTOM_TCP_PORT,
    SSH_PORT,
...
from bigbytes.services.ssh.aws.emr.constants import SSH_DEFAULTS
    ...
    return SetupStep.load(
        ...
        steps=[
            ...
            SetupStep.load(
                ...
                description='The IAM profile used by the service running Bigbytes.',
                tab=ComputeManagementApplicationTab.SETUP,
...
def build_connections(compute_service: ComputeService) -> List[ComputeConnection]:
    ...
    if active_cluster:
        from bigbytes.services.ssh.aws.emr.models import SSHTunnel
            ...
            step_final.actions = [
                ComputeConnectionAction.load(
                    ...
                    description='Start the SSH tunnel between the local machine and '
                                ...
                                'Bigbytes application needs to refresh, '
